    ...
    <div className="bg-stone-200">
      ...
      <div>
        <div className="flex flex-col items-center justify-center px-6 py-24 lg:px-8 bg-stone-200">
          ...
          <h1 className="mt-10 text-4xl tracking-tighter text-gray-900 sm:text-8xl text-center max-w-5xl ">Rejuvenate your mind, body, and soul</h1>
          <p className="mt-6 text-base leading-6 text-gray-600 max-w-lg text-center">Indulge in a serene escape with our luxurious spa treatments designed to refresh your senses and restore balance.</p>
